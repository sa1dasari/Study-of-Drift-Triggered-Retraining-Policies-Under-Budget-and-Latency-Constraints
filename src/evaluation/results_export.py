...
def export_to_json(metrics, policy, config, filepath):
    ...
    export_data = {
        ...
        "performance_metrics": {
            ...
            "overall_f1": summary.get("overall_f1"),
            "pre_drift_f1": summary.get("pre_drift_f1"),
            "post_drift_f1": summary.get("post_drift_f1"),
            "f1_drop": summary.get("f1_drop"),
            "overall_auc": summary.get("overall_auc"),
            "pre_drift_auc": summary.get("pre_drift_auc"),
            "post_drift_auc": summary.get("post_drift_auc"),
            "auc_drop": summary.get("auc_drop"),
        },
        "retraining_metrics": {
