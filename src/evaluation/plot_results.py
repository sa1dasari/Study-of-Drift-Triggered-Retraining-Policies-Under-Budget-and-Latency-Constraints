...
def plot_results(seeds, policy, drift_point, drift_type):
    """
    ...
    Args:
        ...
        drift_type: Type of drift (abrupt/gradual)
    """
    ...
    retrain_times = []
    t = 0
    while t < 10000 and len(retrain_times) < policy.budget:
