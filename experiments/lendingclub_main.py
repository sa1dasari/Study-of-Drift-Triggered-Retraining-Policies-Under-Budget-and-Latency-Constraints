...
def run_policy_sweep(policy_type, df, pool_cache):
    ...
    results_dir = PROJECT_ROOT / f"results_with_retrain/lendingclub/per_run/lendingclub_{policy_type}_{seed_label}"
    results_dir.mkdir(parents=True, exist_ok=True)

    summary_csv = str(PROJECT_ROOT / f"results_with_retrain/lendingclub/csv/lendingclub_summary_{policy_type}_retrain_{seed_label}.csv")
    ...
    plot_output = str(PROJECT_ROOT / f"results_with_retrain/lendingclub/plots/lendingclub_summary_plot_{policy_type}_retrain_{seed_label}.png")
...
def _run_no_retrain_sweep(df, pool_cache):
    ...
    summary_csv = str(PROJECT_ROOT / f"results_with_retrain/lendingclub/csv/lendingclub_summary_{policy_type}_{seed_label}.csv")
    Path(summary_csv).parent.mkdir(parents=True, exist_ok=True)
    Path(summary_csv).unlink(missing_ok=True)
    ...
    plot_output = str(PROJECT_ROOT / f"results_with_retrain/lendingclub/plots/lendingclub_summary_plot_{policy_type}_{seed_label}.png")
    Path(plot_output).parent.mkdir(parents=True, exist_ok=True)
