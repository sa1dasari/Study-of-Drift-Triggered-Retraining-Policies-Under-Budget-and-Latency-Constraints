...
def run_policy_sweep(policy_type, seeds):
    ...
    results_dir = PROJECT_ROOT / f"results_with_retrain/synthetic/per_run/{policy_type}_{run_label}"
    results_dir.mkdir(parents=True, exist_ok=True)

    summary_csv = str(PROJECT_ROOT / f"results_with_retrain/synthetic/csv/summary_results_{policy_type}_retrain_{seed_label}.csv")
    ...
    plot_output = str(PROJECT_ROOT / f"results_with_retrain/synthetic/plots/summary_results_plot_{policy_type}_retrain_{seed_label}.png")
...
def _run_no_retrain_sweep(seeds):
    ...
    summary_csv = str(PROJECT_ROOT / f"results_with_retrain/synthetic/csv/summary_results_{policy_type}_{seed_label}.csv")
    Path(summary_csv).parent.mkdir(parents=True, exist_ok=True)
    Path(summary_csv).unlink(missing_ok=True)
    ...
    plot_output = str(PROJECT_ROOT / f"results_with_retrain/synthetic/plots/summary_results_plot_{policy_type}_{seed_label}.png")
    Path(plot_output).parent.mkdir(parents=True, exist_ok=True)
